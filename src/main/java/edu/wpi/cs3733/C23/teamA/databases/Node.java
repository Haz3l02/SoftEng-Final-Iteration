...
public class Node {
  ...
  public static HashMap<String, Node> getAll() throws SQLException {
  ...
  public ResultSet getSpecificNode(String id) throws SQLException {
  ...
  public int setCoords(int x, int y, String node) throws SQLException {
    String sql =
            String.join(
                    " ",
                    "UPDATE Node "
