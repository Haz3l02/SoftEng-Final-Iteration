...
public class SecurityRequest extends ServiceRequest {
    ...
    // for new request
    public SecurityRequest(
            String name, String idNum, String location, String description, String ul, String requestType, String status, String employeeAssigned, String request, String secPhone) throws SQLException {
    ...
    public SecurityRequest(int requestID, String name, String idNum, String location, String description, String ul, String requestType, String status, String employeeAssigned, String request, String secPhone) {
        // for selecting existing
...
//                            "( '" + name + "', '" + idNum + "', '" + location + "', '" + description + "', '" + category + "', '" + ul + "', '" + requestType + "', '" + status, "', '" + employeeAssigned + "');");
        ...
        sql = String.join(" ",
                ...
                "((select max(requestID) from ServiceRequest), '"+request+"', '" + secPhone + "');" );
        Adb.processUpdate(sql);
    ...
    public ArrayList<SecurityRequest> getSecurityRequestByUser(String id) throws SQLException {
        ...
        while (rs.next()) {
            fin.add(
                    new SecurityRequest(rs.getInt("requestID"),
                            rs.getString("name"),
                            rs.getString("idNum"),
