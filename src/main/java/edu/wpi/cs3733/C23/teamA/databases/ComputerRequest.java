...
public class ComputerRequest extends ServiceRequest {
    ...
    // for new request
    public ComputerRequest(
            String name, String idNum, String location, String description, String ul, String requestType, String status, String employeeAssigned, String deviceID, String device) throws SQLException {
    ...
    public ComputerRequest(int requestID, String name, String idNum, String location, String description, String ul, String requestType, String status, String employeeAssigned, String deviceID, String device) {
        // for selecting existing
...
//                            "( '" + name + "', '" + idNum + "', '" + location + "', '" + description + "', '" + category + "', '" + ul + "', '" + requestType + "', '" + status, "', '" + employeeAssigned + "');");
    ...
    public ArrayList<ComputerRequest> getComputerRequestByUser(String id) throws SQLException {
        ...
        while (rs.next()) {
            fin.add(
                    new ComputerRequest(rs.getInt("requestID"),
                            rs.getString("name"),
                            rs.getString("idNum"),
