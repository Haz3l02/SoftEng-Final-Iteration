...
public class PathfindingController extends ServiceRequestController {
  ...
  /**
   * Method gets called when pathDisplay button is pressed
   * Takes in startNodeID and endNodeID given by user text input
   * Preps graph using prepGraphDB method
   * Prints out the path generated by AStar
   */
  @FXML
